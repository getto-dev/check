    ...
    <section className="px-3 sm:px-4 pt-4 pb-2 sm:pt-6 sm:pb-3 max-w-5xl mx-auto w-full">
      ...
      <div className="flex gap-2 sm:gap-2.5 items-stretch">
        <div className="flex-1 min-w-0 relative">
          ...
          <input type="search" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder="Поиск услуг и материалов" className={cn('search-input w-full min-w-0 pl-10 sm:pl-12 pr-12 py-3 sm:py-3.5 min-h-11 rounded-xl text-sm sm:text-base font-medium bg-card border border-border', 'focus:outline-none focus:border-primary transition-all touch-manipulation')} aria-label="Поиск услуг и материалов" enterKeyHint="search" />
