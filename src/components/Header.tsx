...
export const Header = memo(function Header() {
  ...
  return <header className="sticky top-0 z-50 bg-card/95 backdrop-blur-xl border-b border-border px-3 sm:px-4 py-2.5 sm:py-3 safe-top">
    <div className="relative flex items-center justify-between gap-2 sm:gap-3 max-w-5xl mx-auto">
      ...
      <button type="button" onClick={() => setTab('catalog')} className="absolute left-1/2 -translate-x-1/2 text-base sm:text-lg font-black tracking-tight gradient-text whitespace-nowrap touch-manipulation focus-visible:ring-2 focus-visible:ring-ring sm:static sm:translate-x-0" style={{ fontWeight: 900 }} aria-label="На главную">Smeta</button>
